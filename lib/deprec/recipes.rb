...
require "#{File.dirname(__FILE__)}/recipes/nginx_upstream_fair"
require "#{File.dirname(__FILE__)}/recipes/mysql_cluster"
require "#{File.dirname(__FILE__)}/recipes/ruby_enterprise"
